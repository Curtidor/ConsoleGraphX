...
void RenderTest::Run()
{
    ...
    RenderTest::TimeSpriteDraw(RenderSystem::DrawSprite_SP, Vector3(), sprite, 1000, "DrawSprite_SP");
    RenderTest::TimeSpriteDraw(RenderSystem::DrawSprite_SS, Vector3(), sprite, 1000, "DrawSprite_SS");
...
void RenderTest::TimeSpriteDraw(std::function<void(const Vector3, Sprite*)> drawFunction, const Vector3 vec, Sprite* sprite, int n, const std::string& message)
{
    double total_time = 0;
